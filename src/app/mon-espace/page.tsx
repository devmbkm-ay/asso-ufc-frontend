    ...
    <div className="p-6 md:p-8 max-w-3xl mx-auto space-y-7">
      ...
      <div className="bg-white rounded-xl border border-primary/15 shadow-sm p-5">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/mon-espace/ma-cotisation" className="flex items-center gap-1 text-xs text-primary hover:text-primary/80">
      ...
      {activeCollectes.length > 0 && (
        <div className="bg-white rounded-xl border border-primary/15 shadow-sm overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100">
            ...
            <Link href="/mon-espace/collectes" className="flex items-center gap-1 text-xs text-primary hover:text-primary/80">
      ...
      {nextEvent && (
        <div className="bg-white rounded-xl border border-primary/15 shadow-sm p-5">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/mon-espace/evenements" className="flex items-center gap-1 text-xs text-primary hover:text-primary/80">
              Voir tout <ChevronRight size={13} />
            </Link>
          </div>
