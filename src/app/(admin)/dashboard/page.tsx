    ...
    <div className="p-8 max-w-6xl mx-auto space-y-8">
      ...
      {!publishedEvents ? (
        ...
        <div className="bg-white rounded-xl border border-primary/15 shadow-sm p-5 flex flex-col sm:flex-row sm:items-center gap-4">
          <div className="flex items-center gap-4 flex-1 min-w-0">
            ...
            <div className="min-w-0">
              <Badge className={cn(
                ...
                isToday ? 'bg-emerald-50 text-emerald-700 border-emerald-200' : 'bg-indigo-50 text-primary border-indigo-200',
              )}>
          ...
          <a
            href="/evenements"
            className="inline-flex items-center gap-1 text-xs font-medium text-primary hover:text-primary/80 shrink-0 self-start sm:self-center"
          >
            Gérer <ChevronRight size={13} />
          </a>
        </div>
      ) : (
        <div className="bg-white rounded-xl border border-primary/15 shadow-sm p-5 flex items-center justify-between gap-4">
          ...
          <a href="/evenements" className="inline-flex items-center gap-1 text-xs font-medium text-primary hover:text-primary/80 shrink-0">
