...
const ROLE_META: Record<string, {
  ...
  super_admin: { label: 'Super admin', icon: Crown,    color: 'text-primary',  bg: 'bg-indigo-50',    border: 'border-indigo-200' },
                      ...
                      {isAdding ? (
                        <div className="flex items-center gap-1.5">
                          ...
                          <Button
                            ...
                            className="h-6 px-2 text-[11px] bg-primary hover:bg-primary/90 text-primary-foreground"
                          >
                            OK
                          </Button>
                          <button
